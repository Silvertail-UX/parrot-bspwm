...
source /home/lelowi/powerlevel10k/powerlevel10k.zsh-theme
...
alias fastfetch="fastfetch --logo /home/lelowi/.config/fastfetch/imagen2.png --logo-type kitty-direct --logo-width 35 --logo-height 20"
#bat
alias cat='bat'
...
#------------------------- exports -------------------------
export PATH=/opt/kitty/bin:/usr/local/bin:/usr/bin:/bin:/usr/local/games:/usr/games:/opt/nvim/nvim-linux-x86_64/bin
