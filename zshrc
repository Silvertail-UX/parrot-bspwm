...
# install p10k with --> git clone --depth=1 https://github.com/romkatv/powerlevel10k.git ~/powerlevel10k
...
#--------------------------- alias -------------------------
alias c="clear && printf '\033c' && fastfetch"
...
#------------------------- exports -------------------------
export PATH=/opt/kitty/bin:/usr/local/bin:/usr/bin:/bin:/usr/local/games:/usr/games:/opt/nvim/nvim-linux-x86_64/bin:/usr/sbin:/sbin
